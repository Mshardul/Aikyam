...
public class getUpcomingEvents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_upcoming_events);
...
//        prgDialog.show();
        ...
        try {
            ...
            client.post(this, "http://172.16.130.228:8080/proj/event/getUpcoming", entity, "application/json", new JsonHttpResponseHandler() {
